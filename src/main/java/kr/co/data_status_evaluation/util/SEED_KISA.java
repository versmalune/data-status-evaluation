...
public class SEED_KISA {
    ...
    private static void SeedRound(int L0[], int L1[], int R0[], int R1[],
                                  int K[]) {
        long T00 = 0L;
        long T11 = 0L;
        int T0 = R0[0] ^ K[0];
    ...
    public static void SeedEncrypt(byte pbData[], int pdwRoundKey[],
                                   byte outData[]) {
        int L0[] = new int[1];
        int L1[] = new int[1];
        int R0[] = new int[1];
    ...
    public static void SeedDecrypt(byte pbData[], int pdwRoundKey[],
                                   byte outData[]) {
        int L0[] = new int[1];
        int L1[] = new int[1];
        int R0[] = new int[1];
    ...
    private static void EncRoundKeyUpdate0(int K[], int A[], int B[], int C[],
                                           int D[], int Z) {
        int T0 = A[0];
        A[0] = A[0] >>> 8 ^ B[0] << 24;
        B[0] = B[0] >>> 8 ^ T0 << 24;
    ...
    private static void EncRoundKeyUpdate1(int K[], int A[], int B[], int C[],
                                           int D[], int Z) {
        int T0 = C[0];
        C[0] = C[0] << 8 ^ D[0] >>> 24;
        D[0] = D[0] << 8 ^ T0 >>> 24;
    ...
    private final int NoRoundKeys;
    private final int SeedBlockSize;
    private final int SeedBlockLen;
